...
class RewardManager:
    ...
    def compute(self, previous_distance_to_goal, current_info, action_id):
        """
        Args:
            previous_distance_to_goal: distance before taking action
            current_info: state info dict after action
            action_id: action just taken

        Returns:
            reward, done, goal_reached, collision
        """
